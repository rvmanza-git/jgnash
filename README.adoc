...
You can download jGnash from the https://github.com/rvmanza-git/jgnash/releases/latest[jGnash Download Page].   image:https://img.shields.io/sourceforge/dt/jgnash.svg["Download button", link="https://github.com/rvmanza-git/jgnash/releases/latest"]
